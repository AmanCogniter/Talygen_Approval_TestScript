...
//		companySetupUserPage.clickUser();
	...
	public void createUserForGroup() {
		companySetupUserPage.createUserForGroup();
	}
	public void createUserForREport() {
		companySetupUserPage.createUserForREport();
	}
	public void createUserForRuleWiseReport() {
		companySetupUserPage.createUserForRuleWiseReport();
	}
	/*
	...
	public void deleteUserForApproval() {
		companySetupUserPage.clickOnSearchByName();
		companySetupUserPage.enterUserNameIntoSearchField();
		companySetupUserPage.clickOnSearchButton();
		companySetupUserPage.clickOnCheckBox();
		companySetupUserPage.clickOnDelete();
		companySetupUserPage.clickOnConfirmationButton();
		companySetupUserPage.captureNotifyMessage();
	}
