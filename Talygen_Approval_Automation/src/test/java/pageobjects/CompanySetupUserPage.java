...
public class CompanySetupUserPage extends WebBasePage {
	...
	public void clickOnFullMenu() {
		...
		try {
			...
			if (tourGuide.isDisplayed()) {
				...
				action.moveToElement(tourGuide).click().build().perform();
	...
	public void clickOnCompanySetup() {
		staticWait(2000);
		// clickByJavascript(By.xpath("//a[@data-original-title='User']"), "Company
		// Setup", 20);
	...
	// click on Search by Name text field
	public void clickOnSearchByName() {
		staticWait(2000);

		click(By.xpath("//div/h5/a/span[@id='searchbyname']"), "Search By Name Text Field", 30);

	}

	// enter User name Into Search Field
	public void enterUserNameIntoSearchField() {
		staticWait(5000);

		enter(By.xpath("//div/input[@id='txtsearchByUserName']"), prop.getProperty("userFirstName") +" "+ userNAame,
				"User Name", 20);
	}
	...
	// click on Delete Button
		public void clickOnDelete() {
			...
			clickByJavascript(By.xpath("//span/a[@id='DeleteMultiple']"), "Delete Button", 30);
		...
		// click on Confirmation Button
				...
				// Capture notify Message
				public void captureNotifyMessage() {
					staticWait(5000);

					try {
						WebElement notifyMessage = driver.findElement(By.xpath("//div/span[contains(text(),'User has been successfully deleted')]"));
						...
						// TODO: handle exception
						e.printStackTrace();
						logger.info("User hasn't been successfully deleted");
					}
...
//		System.out.println(date2);
	...
	public void VerifyMandatoryFieldValidation() {
		...
		List<WebElement> errorMessageLocator = findMultipleElement(
				By.xpath("//div[@class='form-group']/descendant::span[contains(@class,'invalid-feedback')]"), 20);
		...
		for (Object expected : expectedValue) {
			...
			// WebElement AsteriskField =
			// findElementVisibility(By.xpath("//label[@class='lblctrlname']/span/parent::label[text()='"
			// + expected +":']"), 45);
			WebElement AsteriskField = findElementVisibility(
					By.xpath("//span[@class='mandatory']/../label[text()='" + expected + "']"), 20);
			// WebElement PasswordAsteriskField =
			// findElementVisibility(By.xpath("//span[@class='text-danger']/ancestor::div[@class='form-group']/descendant::label[text()='"+expected+":']"),
			// 20);
			WebElement PasswordAsteriskField = findElementVisibility(By
					.xpath("//span[@class='text-danger']/ancestor::div[@class='form-group']/descendant::label[text()='"
							+ expected + ":']"),
					20);
	...
	public void selectUserType() {
		// selectValueWithText(By.cssSelector("#Clientdetail_user_type_id"), "Normal
		// User", "Select User Type", 0);
		selectValueWithText(By.xpath("//select[@id='Clientdetail_user_type_id']"), "Normal User", "Select User Type",
				0);
	}
	...
	// enter Email
	public void enterEmailForRuleWiseReport() {
		enter(By.cssSelector("#txtEmail"), prop.getProperty("enterEmail") + datevalue + "@yopmail.com", "Email", 20);
	}

	// enter Email
	public void enterEmailForGroup() {
		enter(By.cssSelector("#txtEmail"), prop.getProperty("enterGroupEmail") + datevalue + "@yopmail.com", "Email",
				20);
	}

	// enter Email
	public void enterEmailForReport() {
		enter(By.cssSelector("#txtEmail"), prop.getProperty("enterREportEmail") + datevalue + "@yopmail.com", "Email",
				20);
	}
	...
	public void clickEnableLoginSwitch() {
		// click(By.xpath("//div[@id='divAttForm']/div[7]/div/div/label/span"), "Enable
		// Login switch", 30);
		click(By.xpath(
				"//label[@class='switch']/input[@id='is_enable_LoginN']/ancestor::asp-checkbox-toggle/descendant::span[@class='slider round']"),
				"Enable Login switch", 30);
	...
	public void selectShift() {
		staticWait(2000);
		// selectValueWithText(By.cssSelector("#Clientdetail_shift_id"), "Select",
		// "Select", 20);
...
//			prop.getProperty("employeeId") 
	...
	public void clickVirtualUserSwitch() {
		// click(By.xpath("//*[@id='divAttForm']/div[15]/div/div/label/span"), "Virtual
		// User switch", 20);
		click(By.xpath(
				"//label[@class='switch']/input[@id='is_virtualN']/ancestor::asp-checkbox-toggle/descendant::span[@class='slider round']"),
				"Virtual User switch", 20);
		// input[@id='chkHourFormatN']//following::span[@class='slider
		// round'][1]//span[@class='slider-no']
	}
	...
	public void SelectcheckBox() {
		click(By.xpath(
				"//div[@class='custom-control custom-checkbox']/input[@class='chkItems custom-control-input']/parent::div"),
				"select CheckBox", 30);
	}
	...
	public void clickPerformanceLicense() {
		 ...
		 * ), 20);
		 */
		findElementPresence(By.xpath("//li/strong[contains(text(),'Performance Review ')]"), 20);
		 ...
		 */
		clickByJavascript(By.xpath(
				"//li/strong[contains(text(),'Approval')]/following-sibling::a[@class='aAddLicense float-right']"),
				"Approval License", 20);
	}
...
//			verifySuccessMessage(By.cssSelector("#notifymessage div"), "Performance Review License", 40);
	...
	public void createUserForREport() {
	...
	public void createUserForRuleWiseReport() {
	...
	public void clickOnCreateNewSkill() {
		clickByJavascript(By.xpath("//a[@data-original-title='Create new Skill']"), "Create New skill", 20);
	}
...
//			js.executeScript("window.scrollBy(0,1000)"); // Scroll vertically down by 1000 pixels
		...
		js.executeScript("arguments[0].scrollIntoView();", Element);
		clickByJavascript(By.xpath("//a[@id='addSkills']"), "Add Skill", 20);// span[text()='
																				// Title']/ancestor::table[@id='manageUserSkill']/descendant::div[@class='custom-control
																				// custom-checkbox']
	}
	...
	public void selectSkillCheckbox() {
		 ...
		 * ), "select Skill", 20);
		 */
		WebElement selectcCheckBox = driver.findElement(By.xpath(
				"//span[text()=' Title']/ancestor::table[@id='manageUserSkill']/descendant::div[@class='custom-control custom-checkbox']"));
	...
	public void enterSkillTitle() {
		...
		enter(By.xpath("//span[@class='mandatory']/ancestor::tg-input/input[@id='SkillName']"), randomTitleName,
				"skill  Name", 20);
	}

	// enter skill description
	public void enterSkillComment() {
		// enter(By.cssSelector("#Description"),
		// prop.getProperty("enterSkillDescription"), "skill Description", 20);
		enter(By.xpath("//span[@class='mandatory']/ancestor::tg-textarea/textarea[@id='Comment']"),
				prop.getProperty("enterSkillDescription"), "skill Description", 20);
	}
	...
	public void clickSaveSkillForUser() {
		staticWait(3000);
		// clickByJavascript(By.xpath("//a[@class='btn btn-success formbtn']"), "Save
		// Skill for created user.", 20);
	...
	public void clickSaveSkill() {
		...
		clickByJavascript(By.xpath("//div[@class='modal-footer']/descendant::button[@data-original-title='Save']"),
				"Save Skill", 20);
	}
...
//			pageNavigate(prop.getProperty("companyUsersListingPage"), "Company Users Listing PageU rl");
	...
	public void feedBackQuestion() {
		staticWait(3000);
		enter(By.xpath("//textarea[@id='FeedbackQuestion']"), prop.getProperty("enterFeedbackQuestion"),
	...
	public void clickontoggleButton() {
		staticWait(3000);
		clickByJavascript(By.xpath("//asp-checkbox-toggle/label[@class='switch']/input[@id='IsAnonymousN']"),
				"toggle button", 20);
	}
	...
	public void selectCheckBox() {
		staticWait(3000);
		click(By.xpath(
				"//th[@id='th-USERNAME']/input[@type='text']/ancestor::tr[@class='search']/descendant::th[@class='nr_customchkbox']/descendant::div[@class='custom-control custom-checkbox']"),
				"Select CheckBox", 20);
	}
